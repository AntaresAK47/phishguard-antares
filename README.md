...
Las versiones exactas validadas en Ubuntu están registradas en requirements-ubuntu-lock.txt.
...
La documentación técnica de auditoría (arquitectura, flujo, seguridad, pruebas y reporte de cambios) se encuentra en:

docs/auditoria_final/
